...
raisedCard.innerHTML = `<p>$${totalAmount.toLocaleString()}</p>`
...
const companyDescription = `A total of $${totalAmount.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${unfundedCount} game${unfundedCount === 1 ? '' : 's'} remain unfunded. We need your help to fund these amazing games!`;
